// CTE Network Core v15 - owner links + Sleeper helpers
(function(){
'use strict';
...
function shellEnd(){document.write('</main><footer class="footer">CTE Network • Official Home of the CTE League • Powered by Sleeper</footer>')}
