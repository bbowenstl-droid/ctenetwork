...
function nav(active){
 const items=[['index.html','HQ','home'],['scores.html','Scores','scores'],['standings.html','Standings','standings'],['teams.html','Teams','teams'],['records.html','Records','records'],['league-history.html','History','history'],['draft-central.html','Draft','draft']];
